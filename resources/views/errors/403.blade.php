...
<body class="simple-page">
	<div id="back-to-home">
		<a href="{{ URL::to('login') }}" class="btn btn-outline btn-default" title="Back Page"><i class="fa fa-home animated zoomIn"></i></a>
	</div>
...
<h2 id="_404_msg" class="animated slideInUp">Oops, an error occur. The page can't be found</h2>
