...
<div class="col-md-12">
	<div class="widget">
		<header class="widget-header">
			<h4 class="col-md-6 widget-title">Indentor Master</h4>
			<div class="col-md-6">
		...
		<div class="widget-body">
			<form class="form-horizontal" role="form" enctype="multipart/form-data" method="POST" action="{{ route('Indentor.store') }}">
				{{ csrf_field() }} 
				<div class="form-group{{ $errors->has('indentor_name') ? ' has-error' : '' }}">
					...
					<div class="col-md-6">
						<input id="indentor_name" type="text" class="form-control" name="indentor_name" value="{{ old('indentor_name') }}">
