...
<div class="col-md-12">
	<div class="widget">
		<header class="widget-header">
			<h4 class="col-md-6 widget-title">Edit UOM</h4>
			<div class="col-md-6">
		...
		<div class="widget-body">
			<form class="form-horizontal" role="form" enctype="multipart/form-data" method="POST" action="{{ route('Uom.update', $uom->id) }}">						
                {{ csrf_field() }}
                <input type="hidden" id="id" name="id" value="<?php echo $uom->id ?>">							
                <div class="form-group{{ $errors->has('uom_name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="uom_name" type="text" class="form-control" name="uom_name" value="{{ old('uom_name',  isset($uom->uom_name) ? $uom->uom_name : null) }}">
