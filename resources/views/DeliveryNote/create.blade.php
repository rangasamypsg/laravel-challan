							...
							<div class="table-responsive">
								<table class="table table-bordered">
									...
									<tr id="row_<?php echo $j; ?>">
										...
										<td><input onkeypress="return isNumberKey(this, event)" onblur="cGSTTotCalculation(<?php echo $j;?>)" id="c_percentage_<?php echo $j; ?>" type="text" class="form-control cPercentage" name="deliveryItem[{{ $i }}][c_percentage]" value="{{ old('deliveryItem.'.$i.'.c_percentage') }}"></td>
										...
										<td><input onkeypress="return isNumberKey(this, event)" onblur="sGSTTotCalculation(<?php echo $j;?>)" id="s_percentage_<?php echo $j; ?>" type="text" class="form-control sPercentage" name="deliveryItem[{{ $i }}][s_percentage]" value="{{ old('deliveryItem.'.$i.'.s_percentage') }}"></td>
										...
										<td><input onkeypress="return isNumberKey(this, event)" onblur="iGSTTotCalculation(<?php echo $j;?>)" id="i_percentage_<?php echo $j; ?>" type="text" class="form-control iPercentage" name="deliveryItem[{{ $i }}][i_percentage]" value="{{ old('deliveryItem.'.$i.'.i_percentage') }}"></td>
